...
def sort_by_cohort(filename):
    ...
    for line in cohort_data:
        ...
        if member_info[4] == 'G':
            ghosts.append(' '.join([member_info[0], member_info[1]]))
        elif member_info[4] == 'I':
            pass
        elif member_info[4] == 'Fall 2015':
            fall_15.append(' '.join([member_info[0], member_info[1]]))
        elif member_info[4] == 'Summer 2016':
            summer_16.append(' '.join([member_info[0], member_info[1]]))
        elif member_info[4] == 'Spring 2016':
            spring_16.append(' '.join([member_info[0], member_info[1]]))
        elif member_info[4] == 'Winter 2016':
